...
<!-- DASHBOARD:START -->
### 📊 Скан 17.09.2026 (после закрытия) — ⚪ обычный день (QQQ RSI2 ≥ 30) — не покупаем, только ведём открытое
QQQ **716.92** (+1.73%) · RSI(2) **85.5** · прошли фильтр: 8
...
Полный дашборд: https://exodus611.github.io/nasdaq-eod-momentum-scanner/ · обновлено 17.09.2026 16:20 ET
<!-- DASHBOARD:END -->
