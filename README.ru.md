...
Что изменилось относительно v1 и почему — в [STRATEGY.ru.md](STRATEGY.ru.md) (по-английски: [STRATEGY.md](STRATEGY.md)). Коротко: сигнал тот же, а вот выход «через 48 часов» рубил отскок посередине (+81 б.п./сделку, 58% прибыльных); выход по SMA10 даёт ему доиграть (+181 б.п., 70%). Тир B и все «каждый день» правила на 2010–2016 убыточны — их больше нет.
